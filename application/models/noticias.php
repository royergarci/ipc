...
class Noticias extends CI_Model {
    ...
    public function traerNoticiaId($id){
    ...
    public function traerNoticiaIdJson($id){
        $results = ' {
            ...
            "tipo": "post",
            "tipo_post": "imagen",
            "titulo": "Isidro Pedraza, Candidato mas solido del PRD",
            "updatedAt": "2016-02-03T07:29:15.374Z"
        }';
        $object = new stdClass();
            //echo $results;
        $res = json_decode($results,true);
        $post = $this->utilerias->arrayToObject($res);
    ...
    "results": [
        ...
        },
        {
            ...
            "updatedAt": "2016-02-03T04:00:41.278Z"
        }
    ]
}';
            ...
            $res = json_decode($results,true);
            //print_r($res['results']);
            //$posts = $this->arrayToObject($res);
            $posts = $this->utilerias->arrayToObject($res);
            //$posts[0]->titulo;
